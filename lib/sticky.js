...
var Sticky = React.createClass({
  ...
  pageOffset: function() {
    ...
    return (this.domNode.ownerDocument.defaultView.pageYOffset || this.domNode.ownerDocument.documentElement.scrollTop) + otherStickyOffsets;
  },
  /*
  ...
  componentDidMount: function() {
    ...
    this.state.events.forEach(function(type) {
      if (this.domNode.ownerDocument.defaultView.addEventListener) {
        this.domNode.ownerDocument.defaultView.addEventListener(type, this.handleEvent);
      } else {
        this.domNode.ownerDocument.defaultView.attachEvent('on' + type, this.handleEvent);
      }
    }, this);
  ...
  componentWillUnmount: function() {
    this.state.events.forEach(function(type) {
      if (this.domNode.ownerDocument.defaultView) {
        if (this.domNode.ownerDocument.defaultView.removeEventListener) {
          this.domNode.ownerDocument.defaultView.removeEventListener(type, this.handleEvent);
        } else {
          this.domNode.ownerDocument.defaultView.detachEvent('on' + type, this.handleEvent)
        }
      }
    }, this);
    this.domNode = null;
